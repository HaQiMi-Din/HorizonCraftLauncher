package com.horizon.launcher.modloaders.modpacks;
...
import com.horizon.launcher.PojavApplication;
import com.horizon.launcher.R;
import com.horizon.launcher.Tools;
import com.horizon.launcher.modloaders.modpacks.api.ModpackApi;
import com.horizon.launcher.modloaders.modpacks.imagecache.ImageReceiver;
import com.horizon.launcher.modloaders.modpacks.imagecache.ModIconCache;
import com.horizon.launcher.modloaders.modpacks.models.Constants;
import com.horizon.launcher.modloaders.modpacks.models.ModDetail;
import com.horizon.launcher.modloaders.modpacks.models.ModItem;
import com.horizon.launcher.modloaders.modpacks.models.SearchFilters;
import com.horizon.launcher.modloaders.modpacks.models.SearchResult;
...
public class ModItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements TaskCountListener {
    ...
    public ModItemAdapter(Resources resources, ModpackApi api, SearchResultCallback callback) {
        // MD3 cards use a fixed ~12dp corner radius for thumbnails
        mCornerRadius = resources.getDimension(R.dimen._12sdp);
        mModpackApi = api;
