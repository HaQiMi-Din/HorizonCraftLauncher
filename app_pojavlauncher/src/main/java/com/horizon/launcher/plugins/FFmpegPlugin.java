package com.horizon.launcher.plugins;
...
public class FFmpegPlugin {
    ...
    public static void discover(Context context) {
        ...
        try {
            PackageInfo ffmpegPluginInfo = manager.getPackageInfo("com.horizon.launcher.ffmpeg", PackageManager.GET_SHARED_LIBRARY_FILES);
