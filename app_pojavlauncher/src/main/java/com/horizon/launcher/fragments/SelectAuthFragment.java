...
public class SelectAuthFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        // All three buttons are MineButtons, already styled with the MD3 accent.
        Button mMicrosoftButton = view.findViewById(R.id.button_microsoft_authentication);
        Button mLocalButton = view.findViewById(R.id.button_local_authentication);
        Button mExternalButton = view.findViewById(R.id.button_external_authentication);
        ...
        mExternalButton.setOnClickListener(v -> Tools.swapFragment(requireActivity(), AuthlibInjectorServerFragment.class, AuthlibInjectorServerFragment.TAG, null));
    }
}
